...
ISSUE_LIST = {
    ...
    2: dict(key='README_FILE_MISSING', severity='error', reason='The required file `README` is missing. See <a href="https://bids-specification.readthedocs.io/en/stable/03-modality-agnostic-files.html#readme">Section 03 (Modality agnostic files)</a> of the BIDS specification.'),
